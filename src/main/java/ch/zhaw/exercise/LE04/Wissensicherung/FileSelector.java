...
public class FileSelector {
    ...
    public File loadFile(Stage stage) {
        ...
        fileChooser.setTitle("Select File"); fileChooser.getExtensionFilters().addAll(extensionfilter); File selectedFile = fileChooser.showOpenDialog(stage);
    ...
    public File saveFile(Stage stage) {
        FileChooser fileChooser = new FileChooser();
        fileChooser.setTitle("Save file"); fileChooser.getExtensionFilters().addAll(extensionfilter); File selectedFile = fileChooser.showSaveDialog(stage);
        if (selectedFile != null) {
            return selectedFile; }
        return null; }
}
