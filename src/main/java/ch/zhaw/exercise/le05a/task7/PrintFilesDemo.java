package ch.zhaw.exercise.le05a.task7;
...
public class PrintFilesDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			walkRecursive(pathToPackage);

			System.out.println("\n simpleJava8Walk");
			simpleJava8Walk(pathToPackage);

			System.out.println("\n simpleJava8Find: *.txt");
			simpleJava8Find(pathToPackage, "txt");

			System.out.println("\n simpleVisit");
			simpleVisit(pathToPackage);

			System.out.println("\n simpleFindVisit:  *.java");
			simpleFindVisit(pathToPackage, "*.java");

			System.out.println("\n simpleFindVisit:  *.txt");
			simpleFindVisit(pathToPackage, "*.txt");
