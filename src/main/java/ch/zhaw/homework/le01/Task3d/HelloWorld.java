package ch.zhaw.homework.le01.Task3d;
...
public class HelloWorld extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.getChildren().add(createButtonLambda("MyNewButton"));
    ...
    public Pane createButtonLambda(String buttonText) {
        ...
        btn.setOnAction(event -> pane.getChildren().add(new Label(buttonText)));
