...
public class LayoutExample extends Application {
    ...
    private Pane createInputPane() {
        ...
        gridPane.setHgap(5);//Abstand zwischen Label auf der horizontale Seite
        gridPane.setVgap(10);//Abstand zwischen Label auf der vertikale Seite
    ...
    private Pane createToolbarPane() {
        ...
        hbox.setStyle("-fx-border-width: 2;-fx-border-color: blue;");
