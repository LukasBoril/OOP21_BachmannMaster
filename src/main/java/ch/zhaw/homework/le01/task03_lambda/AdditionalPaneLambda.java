package ch.zhaw.homework.le01.task03_lambda;
...
public class AdditionalPaneLambda extends Application {
    ...
    Pane createButton() {
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                pane.getChildren().add(new Label("- Anonyme Bo! -"));
            }
        });
        return pane;
    }
