 ...
 */
public class UnitArduino extends LoggingUnit implements WifiInterface, Serializable {
    ...
    //constructor
    public UnitArduino(String unitName, InetAddress ipAdress, String wifissid, String wifipword) {
        super(unitName);
